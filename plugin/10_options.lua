...
vim.o.pumborder      = 'rounded'  -- Place a nice border on the popup menu
vim.o.pumheight      = 10         -- Make popup menu smaller
vim.o.relativenumber = true       -- Show relative line numbers
vim.o.ruler          = false      -- Don't show cursor coordinates
vim.o.shortmess      = 'CFOSWaco' -- Disable some built-in completion messages
vim.o.scrolloff      = 15         -- KeepCursor.nvim handles scrolloff well
...
vim.o.listchars = 'eol:󱞥,extends:…,nbsp:␣,precedes:…,tab:> ,trail:·'
...
vim.o.completeopt = 'menuone,fuzzy,nosort,noselect' -- Use custom behavior
